...
class storeFile(models.Model):
    ...
    server=models.ForeignKey(storeServer,blank=True,null=True, default=1, verbose_name=u'服务器地址')
    order=models.IntegerField(u'排序',default=0,null=True,blank=True )
    size= models.IntegerField(u'大小',default=0,null=True,blank=True )
    def __unicode__(self):
