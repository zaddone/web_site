...
class links_page_info(models.Model):
    ...
    description = models.CharField(u'description',max_length=500)
...
class url_page_info(models.Model):
    url = models.CharField(u'url',max_length=100, unique=True)
    title = models.CharField(u'title',max_length=100)
    keywords = models.CharField(u'keywords',max_length=100)
    description = models.CharField(u'description',max_length=500)
    links=models.ManyToManyField(links_page_info,verbose_name=u'友链')
